...
interface Props extends Omit<InputHTMLAttributes<HTMLInputElement>, 'onChange' | 'className'> {
    value: string
    setValue: (value: string) => void
}

const Search: FC<Props> = ({ value, setValue, placeholder = 'Search', type = 'text', ...restProps }) => {
